...
const lineList = ['t', 'u', 'w', 'x', 'y', 'z', 'q', 'bib'];
            ...
            <Row gutter={[0, 8]} justify={'end'}>
              <Col>
                <Table
                  ...
                  columns={[
                    {
                      title: 'KPI Expected (Kg/h)',
                      dataIndex: 'expected',
                      align: 'center',
                      width: 120,
                    },
                    {
                      title: `${dataSource[lineSelected].lineName} Total Amount (Kg)`,
                      dataIndex: 'amount',
                      align: 'center',
                      width: 150,
                    },
